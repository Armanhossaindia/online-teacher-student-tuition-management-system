        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-soft-primary waves-effect waves-light mb-2" href="{{ route('subjects.create') }}">
              ...
              <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @if ($subject->image)
                      <img src="{{ asset('uploads/subjects/' . $subject->image) }}" alt="{{ $subject->title }}"
                        width="80">
                      @else
                      No Image
                      @endif
                    ...
                    <td>
                      ...
                      <form hidden action="{{ route('subjects.destroy', $subject->id) }}" id="form{{ $subject->id }}"
                        method="get">
                        @csrf
                      </form>
                    ...
                    {{-- <td>
                                            <a href="{{ route('subjects.edit', $subject->id) }}" class="btn btn-sm
                    btn-warning">Edit</a>
